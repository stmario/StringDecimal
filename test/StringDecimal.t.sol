...
import "../src/StringDecimal.sol";

contract StringDecimalTest is Test {
    ...
    function testKeccakValues() public{
        ...
        bytes memory f = bytes(StringDecimal.intToString(int256(42)));
        emit log_bytes(b);
        emit log_bytes(f);
    ...
    function testIntToStringNegative() public{
        string memory res = StringDecimal.intToString(int256(-42));
        string memory hh = "-42";
    ...
    function testIntToStringNegativeMinVal() public{
        string memory res = StringDecimal.intToString(type(int256).min + 1); //TODO: find out why min value gives under/overflow
    ...
    function testIntToToStringPositiveMaxValue() public{
        string memory res = StringDecimal.intToString(type(int256).max);
        string memory hh = "57896044618658097711785492504343953926634992332820282019728792003956564819967";
        if (keccak256(bytes(res)) == keccak256(bytes(hh))){
            assertTrue(true);
        }
    ...
    function testIntToToStringDecimalPositiveSmall() public{
        string memory res = StringDecimal.intToStringDecimal(int256(42), 2);
    ...
    function testIntToToStringDecimalPositiveMedium() public{
        string memory res = StringDecimal.intToStringDecimal(int256(42), 1);
    ...
    function testIntToToStringDecimalPositiveLarge() public{
        string memory res = StringDecimal.intToStringDecimal(type(int256).max, 10);
    ...
    function testIntToToStringDecimalPositiveVerySmall() public{
        string memory res = StringDecimal.intToStringDecimal(42, 3);
    ...
    function testIntToToStringDecimalPositiveVerySmallExtreme() public{
        string memory res = StringDecimal.intToStringDecimal(type(int256).max, 80);
